...
<?php } else {
		...
		if( current_user_can ('manage_options') ) { ?>
			...
			<div id="ha_fsb_container" class="ha-fsb-container <?php echo esc_attr( $wrapper_classes ); ?>"
				...
				<div class="ha-fsb-inner">
					<span class="ha-fsb-inner-content ha-fsb-message-disabled">No shipping zone selected, You must set your free shipping zone from Settings->Shipping Zone, otherwise click</span>
